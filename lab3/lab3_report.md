...
### 🧠 Вывод
В ходе лабораторной работы были получены практические навыки настройки мониторинга в Docker-среде.
Освоены базовые принципы работы Prometheus, Node Exporter и Grafana.
Создана полноценная система мониторинга, способная отслеживать состояние сервера и визуализировать данные в реальном времени.
Полученный результат может быть использован в будущих DevOps-проектах для наблюдения за состоянием сервисов и инфраструктуры.
